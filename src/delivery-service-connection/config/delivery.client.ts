...
const DELIVERY_GRPC_HOST = process.env.DELIVERY_GRPC_HOST || "delivery-boy-service";
const DELIVERY_GRPC_PORT = process.env.DELIVERY_GRPC_PORT || "4000";

const DeliveryBoyService = new grpcObject.delivery_package.DeliveryBoyService(
    `${DELIVERY_GRPC_HOST}:${DELIVERY_GRPC_PORT}`,
